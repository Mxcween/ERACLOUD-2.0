...
HELP_TEXT = (
    ...
    "/range 15-45 - слати лише лоти в цьому діапазоні цін\n"
    "/range all - знову слати всі\n"
