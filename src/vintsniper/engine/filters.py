...
def screen(
    ...
    *,
    ...
    if bucket is None:
        # З назвою стану, а не просто "невідомий": інакше в статистиці видно,
        # що ми щось втрачаємо, але не видно що саме, а це майже завжди
        # незнайомий рядок від Vinted якоюсь мовою, який треба додати в мапу.
        return Rejected(f"невідомий стан {listing.status_title!r}")
